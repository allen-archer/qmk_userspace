...
```
_______           KC_BRID           KC_BRIU           LCTL(LALT(KC_M))  LCTL(KC_F9)       RM_VALD           RM_VALU           KC_MPRV           KC_MPLY           KC_MNXT           KC_MUTE           KC_VOLD           KC_VOLU           RM_TOGG           DM_REC1           DM_RSTP           DM_PLY1
_______           _______           _______           _______           _______           _______           _______           _______           _______           _______           _______           _______           _______           KC_BSPC           _______           _______           MS_WHLU
RM_TOGG           RM_NEXT           RM_VALU           RM_HUEU           RM_SATU           RM_SPDU           _______           _______           _______           _______           _______           _______           _______           _______           _______           _______           MS_WHLD
...
| Fn+PrtSc | `DM_REC1` | Dynamic Macro Record Start 1 |
| Fn+(unused) | `DM_RSTP` | Dynamic Macro Record Stop |
| Fn+Knob Press | `DM_PLY1` | Dynamic Macro Play 1 |
